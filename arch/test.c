...
MOV(INDD(CONST_TABLE, 20), IMM(T_STRING));
MOV(INDD(CONST_TABLE, 21), IMM(5));
MOV(INDD(CONST_TABLE, 22), IMM(111));
MOV(INDD(CONST_TABLE, 23), IMM(100));
MOV(INDD(CONST_TABLE, 24), IMM(100));
MOV(INDD(CONST_TABLE, 25), IMM(45));
MOV(INDD(CONST_TABLE, 26), IMM(50));
MOV(INDD(CONST_TABLE, 27), IMM(T_SYMBOL));
MOV(INDD(CONST_TABLE, 28), IMM(21));
MOV(INDD(CONST_TABLE, 29), IMM(T_STRING));
MOV(INDD(CONST_TABLE, 30), IMM(5));
MOV(INDD(CONST_TABLE, 31), IMM(111));
MOV(INDD(CONST_TABLE, 32), IMM(100));
MOV(INDD(CONST_TABLE, 33), IMM(100));
MOV(INDD(CONST_TABLE, 34), IMM(45));
MOV(INDD(CONST_TABLE, 35), IMM(53));
MOV(INDD(CONST_TABLE, 36), IMM(T_SYMBOL));
MOV(INDD(CONST_TABLE, 37), IMM(30));
MOV(INDD(CONST_TABLE, 38), IMM(T_STRING));
MOV(INDD(CONST_TABLE, 39), IMM(7));
MOV(INDD(CONST_TABLE, 40), IMM(111));
MOV(INDD(CONST_TABLE, 41), IMM(100));
MOV(INDD(CONST_TABLE, 42), IMM(100));
MOV(INDD(CONST_TABLE, 43), IMM(101));
MOV(INDD(CONST_TABLE, 44), IMM(114));
MOV(INDD(CONST_TABLE, 45), IMM(45));
MOV(INDD(CONST_TABLE, 46), IMM(53));
MOV(INDD(CONST_TABLE, 47), IMM(T_SYMBOL));
MOV(INDD(CONST_TABLE, 48), IMM(39));
MOV(INDD(CONST_TABLE, 49), IMM(T_INTEGER));
MOV(INDD(CONST_TABLE, 50), IMM(100));
MOV(INDD(CONST_TABLE, 51), IMM(1));
PUSH(IMM(8));
CALL(MALLOC);
DROP(1);
MOV(SYMBOL_STRING_LIST, IMM(R0));
MOV(INDD(SYMBOL_STRING_LIST, 0), 16);
MOV(INDD(SYMBOL_STRING_LIST, 1), 2);
MOV(INDD(SYMBOL_STRING_LIST, 2), 21);
MOV(INDD(SYMBOL_STRING_LIST, 3), 4);
MOV(INDD(SYMBOL_STRING_LIST, 4), 30);
MOV(INDD(SYMBOL_STRING_LIST, 5), 6);
MOV(INDD(SYMBOL_STRING_LIST, 6), 39);
MOV(INDD(SYMBOL_STRING_LIST, 7), 0);
POP(FP);
RETURN;
...
L_var_list_loop_g48:
CMP(R2, 0);
JUMP_LE(L_var_list_loop_end_g47);
PUSH(IMM(R0));
PUSH(STACK(R3));
CALL(MAKE_SOB_PAIR);
DROP(2);
INCR(R3);
DECR(R2);
JUMP(L_var_list_loop_g48);
L_var_list_loop_end_g47:
// Fix the stack
CMP(R6, 0);
JUMP_EQ(L_fix_stack_empty_var_list_g44);
MOV(R1, IMM(FP));
SUB(R1, IMM(3));
...
L_stack_loop_g46:
CMP(R2, IMM(FP));
JUMP_GE(L_stack_fix_end_g45);
MOV(STACK(R1), STACK(R2));
INCR(R1);
INCR(R2);
JUMP(L_stack_loop_g46);
L_fix_stack_empty_var_list_g44:
...
INCR(R1);
MOV(R2, IMM(FP));
L_fix_stack_empty_loop_g43:
CMP(R2, IMM(R3));
JUMP_LE(L_stack_fix_empty_end_g42);
MOV(STACK(R1), STACK(R2));
DECR(R1);
DECR(R2);
JUMP(L_fix_stack_empty_loop_g43);
L_stack_fix_empty_end_g42:
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g54:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g55);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g54);
L_clos_copy_env_exit_g55:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g58);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g58:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g56:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g57);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g56);
L_clos_copy_params_exit_g57:
...
MOV(INDD(R0, 2), LABEL(L_clos_body_g53));
JUMP(L_clos_exit_g59);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g63:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g62);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g63);
L_fix_stack_loop_end_g62:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
JUMP(L_if3_exit_g60);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g52:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g51);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g52);
L_fix_stack_loop_end_g51:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g73:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g72);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g73);
L_fix_stack_loop_end_g72:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
JUMP(L_if3_exit_g68);
...
L_var_list_loop_g81:
CMP(R2, 0);
JUMP_LE(L_var_list_loop_end_g80);
PUSH(IMM(R0));
PUSH(STACK(R3));
CALL(MAKE_SOB_PAIR);
DROP(2);
INCR(R3);
DECR(R2);
JUMP(L_var_list_loop_g81);
L_var_list_loop_end_g80:
// Fix the stack
CMP(R6, 0);
JUMP_EQ(L_fix_stack_empty_var_list_g77);
MOV(R1, IMM(FP));
SUB(R1, IMM(3));
SUB(R1, FPARG(1)); // R1 = bottom
MOV(R2, IMM(FP));
...
L_stack_loop_g79:
CMP(R2, IMM(FP));
JUMP_GE(L_stack_fix_end_g78);
MOV(STACK(R1), STACK(R2));
INCR(R1);
INCR(R2);
JUMP(L_stack_loop_g79);
L_fix_stack_empty_var_list_g77:
// Init R3 with the loop limit (position of first optional var in original stack)
MOV(R3, IMM(FP));
SUB(R3, IMM(4));
MOV(R1, IMM(FP));
INCR(R1);
MOV(R2, IMM(FP));
L_fix_stack_empty_loop_g76:
CMP(R2, IMM(R3));
JUMP_LE(L_stack_fix_empty_end_g75);
MOV(STACK(R1), STACK(R2));
DECR(R1);
DECR(R2);
JUMP(L_fix_stack_empty_loop_g76);
L_stack_fix_empty_end_g75:
// Fix R1 to point to the new FP since the code below relies on that
MOV(R1, IMM(FP));
INCR(R1);
L_stack_fix_end_g78:
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g86:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g87);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g86);
L_clos_copy_env_exit_g87:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g90);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g90:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g88:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g89);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g88);
L_clos_copy_params_exit_g89:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g85));
JUMP(L_clos_exit_g91);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g95:
CMP(R3, IMM(2));
JUMP_GE(L_clos_copy_env_exit_g96);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g95);
L_clos_copy_env_exit_g96:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g99);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g99:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g97:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g98);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g97);
L_clos_copy_params_exit_g98:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g94));
JUMP(L_clos_exit_g100);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g104:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g103);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g104);
L_fix_stack_loop_end_g103:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g93:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g92);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g93);
L_fix_stack_loop_end_g92:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g109:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g110);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g109);
L_clos_copy_env_exit_g110:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g113);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g113:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g111:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g112);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g111);
L_clos_copy_params_exit_g112:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g108));
JUMP(L_clos_exit_g114);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g118:
CMP(R3, IMM(2));
JUMP_GE(L_clos_copy_env_exit_g119);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g118);
L_clos_copy_env_exit_g119:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g122);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g122:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g120:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g121);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g120);
L_clos_copy_params_exit_g121:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g117));
JUMP(L_clos_exit_g123);
...
DROP(IMM(R1));
CMP(R0, IMM(SOB_FALSE));
JUMP_EQ(L_if3_else_g125);
// (pvar acc 1)
MOV(R0, FPARG(3));
JUMP(L_if3_exit_g124);
L_if3_else_g125:
// tc-applic
// applic
// (pvar acc 1)
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g127:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g126);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g127);
L_fix_stack_loop_end_g126:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g116:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g115);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g116);
L_fix_stack_loop_end_g115:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
...
DROP(IMM(R1));
CMP(R0, IMM(SOB_FALSE));
JUMP_EQ(L_if3_else_g131);
// (pvar m 1)
MOV(R0, FPARG(3));
JUMP(L_if3_exit_g130);
L_if3_else_g131:
// tc-applic
// applic
// (pvar m 1)
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g133:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g132);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g133);
L_fix_stack_loop_end_g132:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
SUB(R3, IMM(4));
SUB(R3, FPARG(1)); // Save increasing stack pointer in R3
L_var_list_loop_g141:
CMP(R2, 0);
JUMP_LE(L_var_list_loop_end_g140);
PUSH(IMM(R0));
PUSH(STACK(R3));
CALL(MAKE_SOB_PAIR);
DROP(2);
INCR(R3);
DECR(R2);
JUMP(L_var_list_loop_g141);
L_var_list_loop_end_g140:
// Fix the stack
CMP(R6, 0);
JUMP_EQ(L_fix_stack_empty_var_list_g137);
MOV(R1, IMM(FP));
SUB(R1, IMM(3));
SUB(R1, FPARG(1)); // R1 = bottom
MOV(R2, IMM(FP));
...
L_stack_loop_g139:
CMP(R2, IMM(FP));
JUMP_GE(L_stack_fix_end_g138);
MOV(STACK(R1), STACK(R2));
INCR(R1);
INCR(R2);
JUMP(L_stack_loop_g139);
L_fix_stack_empty_var_list_g137:
// Init R3 with the loop limit (position of first optional var in original stack)
MOV(R3, IMM(FP));
SUB(R3, IMM(4));
MOV(R1, IMM(FP));
INCR(R1);
MOV(R2, IMM(FP));
L_fix_stack_empty_loop_g136:
CMP(R2, IMM(R3));
JUMP_LE(L_stack_fix_empty_end_g135);
MOV(STACK(R1), STACK(R2));
DECR(R1);
DECR(R2);
JUMP(L_fix_stack_empty_loop_g136);
L_stack_fix_empty_end_g135:
// Fix R1 to point to the new FP since the code below relies on that
MOV(R1, IMM(FP));
INCR(R1);
L_stack_fix_end_g138:
// Fix FP and SP
MOV(FP, IMM(R1));
MOV(SP, IMM(FP));
// Fix the number of params
...
L_or_exit_g159:
CMP(R0, IMM(SOB_FALSE));
JUMP_EQ(L_if3_else_g143);
// (pvar v 0)
MOV(R0, FPARG(2));
JUMP(L_if3_exit_g142);
L_if3_else_g143:
// if3
// applic
// (const 2)
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g158:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g157);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g158);
L_fix_stack_loop_end_g157:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
JUMP(L_if3_exit_g144);
L_if3_else_g145:
// tc-applic
// applic
// applic
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g149:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g150);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g149);
L_clos_copy_env_exit_g150:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g153);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g153:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g151:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g152);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g151);
L_clos_copy_params_exit_g152:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g148));
JUMP(L_clos_exit_g154);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g156:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g155);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g156);
L_fix_stack_loop_end_g155:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g147:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g146);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g147);
L_fix_stack_loop_end_g146:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
MOV(INDD(GLOBAL_TABLE, 53), IMM(T_UNDEFINED));
MOV(INDD(GLOBAL_TABLE, 54), IMM(T_UNDEFINED));
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g184:
CMP(R3, IMM(0));
JUMP_GE(L_clos_copy_env_exit_g185);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g184);
L_clos_copy_env_exit_g185:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g188);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g188:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g186:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g187);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g186);
L_clos_copy_params_exit_g187:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g183));
JUMP(L_clos_exit_g189);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g191:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g190);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g191);
L_fix_stack_loop_end_g190:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g193:
CMP(R3, IMM(0));
JUMP_GE(L_clos_copy_env_exit_g194);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g193);
L_clos_copy_env_exit_g194:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g197);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g197:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g195:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g196);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g195);
L_clos_copy_params_exit_g196:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g192));
JUMP(L_clos_exit_g198);
...
// Actual body
// seq
// (set (pvar even-1? 0) (box (pvar even-1? 0)))
// (box (pvar even-1? 0))
// (pvar even-1? 0)
MOV(R0, FPARG(2));
PUSH(IMM(R0));
...
POP(R1);
MOV(STACK(R0), R1);
// (set (pvar odd-2? 1) (box (pvar odd-2? 1)))
// (box (pvar odd-2? 1))
// (pvar odd-2? 1)
MOV(R0, FPARG(3));
PUSH(IMM(R0));
...
POP(R1);
MOV(STACK(R0), R1);
// (set (pvar even-3? 2) (box (pvar even-3? 2)))
// (box (pvar even-3? 2))
// (pvar even-3? 2)
MOV(R0, FPARG(4));
PUSH(IMM(R0));
...
POP(R1);
MOV(STACK(R0), R1);
// (set (pvar odd-5? 3) (box (pvar odd-5? 3)))
// (box (pvar odd-5? 3))
// (pvar odd-5? 3)
MOV(R0, FPARG(5));
PUSH(IMM(R0));
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g221:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g222);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g221);
L_clos_copy_env_exit_g222:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g225);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g225:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g223:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g224);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g223);
L_clos_copy_params_exit_g224:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g220));
JUMP(L_clos_exit_g226);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g229:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g228);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g229);
L_fix_stack_loop_end_g228:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
CMP(R0, IMM(SOB_FALSE));
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g231:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g232);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g231);
L_clos_copy_env_exit_g232:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g235);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g235:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g233:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g234);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g233);
L_clos_copy_params_exit_g234:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g230));
JUMP(L_clos_exit_g236);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g240:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g239);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g240);
L_fix_stack_loop_end_g239:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
JUMP(L_if3_exit_g237);
L_if3_else_g238:
// (const #f)
MOV(R0, CONST_TABLE);
ADD(R0, 2);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g200:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g201);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g200);
L_clos_copy_env_exit_g201:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g204);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g204:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g202:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g203);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g202);
L_clos_copy_params_exit_g203:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g199));
JUMP(L_clos_exit_g205);
...
DROP(IMM(R1));
PUSH(IMM(R0));
PUSH(IMM(5)); // Num of params
// (box-get (bvar odd-5? 0 3))
// (bvar odd-5? 0 3)
MOV(R0, FPARG(0));
MOV(R0, INDD(R0, 0));
MOV(R0, INDD(R0, 3));
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g208:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g207);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g208);
L_fix_stack_loop_end_g207:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
CMP(R0, IMM(SOB_FALSE));
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g210:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g211);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g210);
L_clos_copy_env_exit_g211:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g214);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g214:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g212:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g213);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g212);
L_clos_copy_params_exit_g213:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g209));
JUMP(L_clos_exit_g215);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g219:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g218);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g219);
L_fix_stack_loop_end_g218:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
JUMP(L_if3_exit_g216);
L_if3_else_g217:
// (const #f)
MOV(R0, CONST_TABLE);
ADD(R0, 2);
