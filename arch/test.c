...
MOV(INDD(CONST_TABLE, 12), IMM(T_STRING));
MOV(INDD(CONST_TABLE, 13), IMM(3));
MOV(INDD(CONST_TABLE, 14), IMM(97));
MOV(INDD(CONST_TABLE, 15), IMM(115));
MOV(INDD(CONST_TABLE, 16), IMM(100));
POP(FP);
RETURN;
...
MOV(INDD(GLOBAL_TABLE, 39), IMM(T_UNDEFINED));
