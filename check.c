...
MOV(INDD(CONST_TABLE, 21), IMM(97));
MOV(INDD(CONST_TABLE, 22), IMM(1));
MOV(INDD(CONST_TABLE, 23), IMM(T_INTEGER));
MOV(INDD(CONST_TABLE, 24), IMM(98));
MOV(INDD(CONST_TABLE, 25), IMM(1));
MOV(INDD(CONST_TABLE, 26), IMM(T_STRING));
MOV(INDD(CONST_TABLE, 27), IMM(2));
MOV(INDD(CONST_TABLE, 28), IMM(97));
MOV(INDD(CONST_TABLE, 29), IMM(98));
MOV(INDD(CONST_TABLE, 30), IMM(T_SYMBOL));
MOV(INDD(CONST_TABLE, 31), IMM(27));
PUSH(IMM(4));
CALL(MALLOC);
DROP(1);
MOV(SYMBOL_STRING_LIST, IMM(R0));
//create_symbol_tableeeeeeeeee
MOV(INDD(SYMBOL_STRING_LIST, 0), 16);
MOV(INDD(SYMBOL_STRING_LIST, 1),R9 + 2);
//create_symbol_tableeeeeeeeee
MOV(INDD(SYMBOL_STRING_LIST, 2), 27);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g135:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g134);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g135);
L_fix_stack_loop_end_g134:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g124:
CMP(R3, IMM(1));
JUMP_GE(L_clos_copy_env_exit_g125);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g124);
L_clos_copy_env_exit_g125:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g128);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g128:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g126:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g127);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g126);
L_clos_copy_params_exit_g127:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g123));
JUMP(L_clos_exit_g129);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g122:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g121);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g122);
L_fix_stack_loop_end_g121:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g153:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g152);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g153);
L_fix_stack_loop_end_g152:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
...
XOR(R3, R3);
MOV(R4, 1);
L_clos_copy_env_begin_g160:
CMP(R3, IMM(0));
JUMP_GE(L_clos_copy_env_exit_g161);
MOV(R5, R2);
ADD(R5, R4);
MOV(R6, R1);
ADD(R6, R3);
...
INCR(R3);
INCR(R4);
JUMP(L_clos_copy_env_begin_g160);
L_clos_copy_env_exit_g161:
...
MOV(IND(R2), R0);
CMP(R3, IMM(0));
JUMP_NE(L_clos_params_not_empty_g164);
MOV(IND(R2), IMM(E_EMPTY));
L_clos_params_not_empty_g164:

// Copy last lambda params
XOR(R4, R4);
MOV(R5, 1);
L_clos_copy_params_begin_g162:
CMP(R4, IMM(R3));
JUMP_GE(L_clos_copy_params_exit_g163);
MOV(R6, IND(R2));
ADD(R6, R4);
MOV(R7, IMM(FP));
SUB(R7, IMM(4));
...
INCR(R4);
INCR(R5);
JUMP(L_clos_copy_params_begin_g162);
L_clos_copy_params_exit_g163:
...
MOV(INDD(R0, 0), T_CLOSURE);
MOV(INDD(R0, 1), IMM(R2)); // env
MOV(INDD(R0, 2), LABEL(L_clos_body_g159));
JUMP(L_clos_exit_g165);
...
SUB(R2, STACK(R2)); // R2 = bottom
MOV(R3, IMM(FP));
L_fix_stack_loop_g167:
CMP(R3, IMM(SP));
JUMP_GE(L_fix_stack_loop_end_g166);
MOV(STACK(R2), STACK(R3));
INCR(R2);
INCR(R3);
JUMP(L_fix_stack_loop_g167);
L_fix_stack_loop_end_g166:
MOV(SP, IMM(R2));
MOV(FP, R1);
JUMPA(INDD(R0, 2));
POP(FP);
